...
export default class EditPost extends Component {
  constructor(props) {
    ...
    this.onChangeContentimg = this.onChangeImg.bind(this);
    this.onChangeContentimg2 = this.onChangeImg.bind(this);
  ...
  componentDidMount() {
    axios
      .get(`${mainurl}post/` + this.props.match.params.id)
      .then((response) => {
        this.setState({
          title: response.data.title,
          article: response.data.article,
          img: response.data.img,
          contentimg: response.data.contentimg,
  ...
  onSubmit(e) {
    ...
    axios({
      url: `${mainurl}post/update/${this.props.match.params.id}`,
      method: 'POST',
      headers: {
      ...
      .then((response) => {
        ...
        alert('Post is updated succesfully');
        this.setState({
          title: '',
          article: '',
          img: '',
